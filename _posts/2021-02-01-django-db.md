...
toc: true
layout: post
description: Adding a Database to a Django App
categories: [django, heroku, database, github]
title: Persistent storage using a SQL-based database for Django (development and deployment on Heroku).
...
* A Django app. For example, the Django "Hello World" App.
    * [GitHub repository](https://github.com/stefanbschneider/django-hello-world)
...
# Persistent Storage with Django
...
# PostgreSQL® DB for Deployment on Heroku
